...
@Transactional
class ProductServiceTest extends IntergrationTestSupport {
    ...
    @DisplayName("신규 상품을 등록할 때 신규 상품을 등록하면 상품번호는 001이다.")
    @Test
    ...
    @DisplayName("신규 상품을 등록한다.2 상품번호는 가장 최근 상품의 상품번호에서 1 증가한 값이다.")
    @Test
    void createProduct2() {
        // given
        Product product1 = createProduct("001", HANDMADE, SELLING, "아메리카노", 4000);
        ...
        assertThat(productResponse)
                .extracting("productNumber", "type", "sellingStatus", "name", "price")
                .contains("004", HANDMADE, "카푸치노", SELLING, 5000);
    }
