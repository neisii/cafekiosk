...
public class ProductControllerDocsTest extends RestDocsSupport {
  ...
  void createProduct() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andDo(document("product-create", // Test's Id
            preprocessRequest(prettyPrint()),
            preprocessResponse(prettyPrint()),
            requestFields( // Snippets: Request
                fieldWithPath("type").type(JsonFieldType.STRING).description("상품 타입"), // Enum은 String 으로
            ...
            responseFields( // Snippets: Response
